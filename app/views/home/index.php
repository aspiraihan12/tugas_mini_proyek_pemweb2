...
<body>
    ...
    <header>
        ...
        <div class="icons">
            <a style="text-decoration:none" href="#" class="fas fa-shopping-cart"></a>
            <a style="text-decoration:none" href="#" onclick="return confirm('Apakah anda yakin ingin keluar ?')" class="fas fa-sign-out"></a>
            <a style="text-decoration:none" href="#" class="fa-sharp fa-solid fa-user"></a>
        </div>
    </header>
    ...
    <section class="home" id="home">
        ...
        <div class="video-container">
            <video src="shoes.mov" loop autoplay muted></video>
        </div>
...
<section class="about" id="about">
    ...
    <div class="row">
        <div class="video-container">
            <video src="download_1.mov" loop autoplay muted></video>
             <h3>TOKO SEPATU</h3>
        </div>
...
<section class="products" id="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="public/css/img/adidass.jpeg" alt="">
                <div class="icons">
                    <a  style="text-decoration:none" href="#" class="cart-btn">add to cart</a>
                </div>
            </div>
            <div class="content">
                <h3>Adidas</h3>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Nike</h3>
                <div class="price"> 16.000,00 <span>20.000,00</span> </div>
            </div>
        </div>
    </div>
